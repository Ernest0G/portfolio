  ...
  return (
    <div id={`item${index + 1}`} className="carousel-item w-full sm:justify-center">
      <div className="card w-full text-white sm:items-center">
        <div className="card-body sm:w-11/12 sm:h-1/2 bg-black sm:rounded-xl sm:items-center">
          <span className="card-title text-lg sm:text-3xl">{title}</span>
          <div className="collapse collapse-arrow">
            <input type="checkbox" />
            <div className="collapse-title text-xl sm:text-3xl font-medium text-white">Description</div>
          ...
          <div className="collapse collapse-arrow">
            <input type="checkbox" />
            <div className="collapse-title text-xl sm:text-3xl font-medium text-white">Images</div>
            <div className="collapse-content">
              <span className="text-white">
                <div className="card w-full shadow-lg">
          ...
          <div className="collapse collapse-arrow">
            <input type="checkbox" />
            <div className="collapse-title text-xl sm:text-3xl font-medium text-white">Tools Used</div>
            <div className="collapse-content">
              <div className="card w-full shadow-lg">
